    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      ...
      >
        ...
        <View style={styles.topBar}>
          <Pressable onPress={() => router.back()} hitSlop={10} style={({ pressed }) => [styles.iconBtn, pressed && styles.pressed]}>
            <Text style={styles.iconText}>✕</Text>
          </Pressable>

          {/* Name -> opens RenameDialog */}
          <Pressable onPress={() => node && setRenameOpen(true)} style={({ pressed }) => [styles.titleWrap, pressed && styles.pressed]}>
        ...
        {/* Submit (lifted above system nav buttons) */}
