...
export default function NodeListScreen({ ids = ["56e95ad81802e038d2b777dcd68c8009","f8f4aabaa0e7a266806cad00b8210e53","a8f751c6a089fbcbe615cea54ef060b1","f34a935a126dc32736f280bf5a64b31a","f33805d6a982913089fe5123bca3b37f","65c4bd13ac1cc0257257760337200c96","4bc14f8ceb3fa6be5a5952c4abf86a34","72e856ef1a54841380381921777529f6","2f1ae4a920cf3a6766bea094a318cbf6","19870ea7280ea86ae5f4288f2e96cd18","964f62581df075f4f29a5edffbea3d24"], page="home", setPage=()=>{}}) {
  ...
  function chnageFolder(folder,ids){
    folderStackRef.current.push({ids:idList, folder:page}); // push where we came from
    console.log(ids);
    setIdlist(ids);
    setPage(folder);
  }
  const goBackFolder = useCallback(() => {
   ...
   const onBackPress = useCallback(() => {
    ...
    if (!handled) router.back(); // default action when stack empty
  }, [goBackFolder, router]);
  ...
  useEffect(() => {
    const sub = BackHandler.addEventListener("hardwareBackPress", () => {
      ...
      return false; // allow system/router default
    });
    return () => sub.remove();
  }, [goBackFolder]);
  useEffect(() => {
   ...
   return (
    <View style={styles.page}>
      <FlatList
        ...
        renderItem={({ item: id }) => <Node id={id} onListUpdate={setIdTORemove} onFolderUpdate={chnageFolder}/>}
      />
    </View>
  );
}
